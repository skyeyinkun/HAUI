...
import {
    ...
    Eraser, PanelRight, PinOff, Mic, Volume2, Keyboard, ArrowUp
} from 'lucide-react';
                        ...
                        <AnimatePresence mode="popLayout">
                            {inputValue.trim() && (
                                <motion.button
                                    ...
                                    disabled={isLoading}
                                    className="p-2 bg-[#334155] text-white rounded-full shadow-md hover:opacity-90 disabled:opacity-50 transition-all flex items-center justify-center"
...
export default function AiChatWidget({ entities }: AiChatWidgetProps) {
    ...
    const modalClass = viewMode === 'sidebar'
        ...
        : 'fixed bottom-24 right-6 w-[calc(100vw-48px)] max-w-[380px] h-[650px] max-h-[80vh] rounded-[24px] shadow-2xl';
