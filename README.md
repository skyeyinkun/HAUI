...
5.14.0 是面向正式交付的 Add-on 优先版本，核心目标是让 HAUI 更适合个人开发者做一次性部署销售，同时保持 Home Assistant 内嵌使用、PWA 安装和平板墙屏体验的一致性。
...
- **离线授权闭环**：支持 Add-on 后端机器码、ECDSA 授权码验签和系统入口授权门禁，不要求开发者额外搭建授权服务器。
