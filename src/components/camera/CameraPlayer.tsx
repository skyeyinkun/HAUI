...
export const CameraPlayer: React.FC<CameraPlayerProps> = ({ config, onRemove }) => {
    ...
    const handleFullscreen = () => {
        ...
        const fullscreenMethod = container?.requestFullscreen || (container as any)?.webkitRequestFullscreen || (container as any)?.mozRequestFullScreen || (container as any)?.msRequestFullscreen;
