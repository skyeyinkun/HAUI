...
import { ICON_PROPS, ICON_SIZES } from '@/styles/icon-constants';
    ...
    <div className={className || "w-full max-w-[600px] p-4 bg-card border rounded-xl shadow-xl flex flex-col"}>
      ...
      <div className="px-4 pt-3 pb-2">
        <div className="relative">
          <Search {...ICON_PROPS.search} className="absolute left-2.5 top-1/2 -translate-y-1/2 pointer-events-none" />
          <input
            type="text"
          ...
          {displayIcons.map(iconName => {
            ...
            return (
              ...
              >
                <svg
                  viewBox="0 0 24 24"
                  style={{ width: ICON_SIZES.picker.grid, height: ICON_SIZES.picker.grid }}
                  className="shrink-0"
                  fill="currentColor"
                >
                  <path d={path} />
