...
- **版本同步**：根前端包、Add-on 包、HA 自定义集成、Service Worker 缓存版本和运行时显示版本统一更新为 `5.15.15`。
- **UI 发布记录**：记录本轮黑白灰磨砂玻璃仪表盘、底部导航、设置和授权界面的视觉优化版本。

### 文档

- **发布文档同步**：README、用户手册、Add-on 文档和商业交付文档同步到 `5.15.15`。
