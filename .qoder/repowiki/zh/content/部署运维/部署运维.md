...
## 更新摘要
**所做的更改**
- 更新版本信息：从3.24.0回退到3.12.21
- 调整依赖版本范围以匹配3.12.21版本状态
- 更新发布流程中的版本号处理逻辑
- 更新配置文件中的版本标识
...
**更新** 本版本已从3.24.0回退到3.12.21，确保与实际代码状态保持一致。
...
**更新** 版本信息已更新为3.12.21，确保与实际代码状态一致。
...
**更新** 本版本已从3.24.0回退到3.12.21，确保文档与实际代码状态保持一致。
...
- [package.json:6-12](file://package.json#L6-L12)
- [cypress.config.ts:1-11](file://cypress.config.ts#L1-L11)
- [CHANGELOG.md:16-209](file://CHANGELOG.md#L16-L209)