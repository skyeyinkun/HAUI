...
import { Wind, X as XIcon, Fan, ThermometerSun } from 'lucide-react';
    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          {/* 温度旋钮区 - 优化间距，减少旋钮与胶囊/控制面板的空白 */}
          <div className="relative flex justify-center items-center -mt-4 -mb-10 scale-[0.8] shrink-0" ref={dialRef} onMouseDown={handleMouseDown}>
          ...
          {/* ===== 控制面板 - 固定网格布局 (无滑动) ===== */}
          <div className="bg-card flex-1 px-4 pb-5 pt-0 z-10 relative flex flex-col gap-2">
            ...
            {/* 风速选择 (Grid 5) - 使用统一的 FanModeIcon 组件 */}
            <div>
              ...
              <div className="flex flex-wrap justify-center gap-3">
                {availableFanModes.map((fan: { id: string; label: string; level: number }) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <FanModeIcon fanId={fan.id} isActive={isActive} size={20} />
            ...
            <div>
              ...
              <div className="flex flex-wrap justify-center gap-3">
                ...
                <div className="contents">
                  {availableHvacModes.map((m: { id: string; icon: React.ComponentType<any>; label: string; color: string; bgColor?: string }) => {
