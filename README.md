...
![version](https://img.shields.io/badge/version-5.15.15-blue.svg)
...
5.15.15 是版本同步与玻璃质感 UI 更新版本，重点统一前端包、Add-on、HA 自定义集成和运行时显示版本，并延续 Add-on 优先商业交付模型。

- **版本统一**：根前端包、Add-on 包、HA 自定义集成、Service Worker 缓存版本和界面底部版本号统一为 `5.15.15`。
- **黑白玻璃质感**：仪表盘、导航、卡片、设置和授权界面沿用本轮黑白灰磨砂玻璃视觉风格。
