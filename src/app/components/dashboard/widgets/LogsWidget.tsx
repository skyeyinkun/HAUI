...
export function LogsWidget({ logs, setLogModalOpen, clearLogs, logContainerRef }: LogsWidgetProps) {
  return (
    <div className="bg-card rounded-[16px] shadow-[var(--shadow-card)] p-3 flex flex-col gap-2 transition-colors duration-300 relative group aspect-auto h-full overflow-hidden box-border">
      {/* 头部：标题 */}
