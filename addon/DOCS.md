...
5.4.0 是面向正式交付的 Add-on 优先版本：推荐通过 Home Assistant 左侧栏使用，手机和平板可用 PWA 添加到主屏幕，暂不包含 Android/iOS 原生 App 包。

## 5.4.0 更新重点

- Add-on、根前端包、HA 自定义集成版本统一为 `5.4.0`。
...
3. 更新 **HAUI - 智能家庭中枢** 到 `5.4.0`。
4. 启动 Add-on 后进入 HAUI，确认底部版本号显示 `HAUI v5.4.0`。
