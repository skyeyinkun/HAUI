...
| **AI 集成** | OpenAI Compatible SSE | 阿里云百炼 / DeepSeek / SiliconFlow 支持 |
...
| 自然语言控制 | "打开客厅灯"等口语化指令 | ✅ |
| 设备状态查询 | "卧室温度多少" | ✅ |
| 状态汇总分析 | 汇总开启设备、传感器读数、离线和低电量设备 | ✅ |
| 低风险设备控制 | 通过 Home Assistant 服务安全控制灯光、窗帘、空调等 | ✅ |
| Agent 控制台 | 三通道模型配置、提案、记忆、心跳、工具和审计 | ✅ |
| 智能推荐 | 基于当前设备状态的自动化建议 | ✅ |
| 异常提醒 | 设备异常状态主动提醒 | 🚧 |

详细说明、名词解释和使用步骤见 [HAUI AI 助手详细指南](./docs/AI_ASSISTANT_GUIDE.md)。
